...
function Chat({ }: Props) {
    return (
        <div className=' relative w-screen h-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center'>
            <img className='relative pt-11 h-[300px]' src="https://nbcsports.brightspotcdn.com/dims4/default/950438a/2147483647/strip/true/crop/1570x1304+0+0/resize/843x700!/quality/90/?url=https%3A%2F%2Fnbc-sports-production-nbc-sports.s3.us-east-1.amazonaws.com%2Fbrightspot%2Fcb%2F8a%2Fc3607b5b1e810adcb9163838534c%2Fscreenshot-2023-05-28-at-1-48-11-pm.png" alt="" />
